...
namespace ZiTools
{
	public class ObjectSeeker_Window : Window
	{
		...
		protected override void SetInitialSizeAndPosition() => windowRect = new Rect(UI.screenWidth - InitialSize.x, UI.screenHeight - InitialSize.y - 150f, InitialSize.x, InitialSize.y);
		...
		public override void DoWindowContents(Rect inRect)
		{
            ...
            var lineNum = -1;
            DrawObjectsList(position, cusomUnit, 1, ref favChange, true);
            ...
            foreach (var unit in units)
			{
				try
				{
					DrawObjectsList(position, unit, lineNum, ref favChange);
				}
				catch (Exception ex)
				{
		...
		private void DrawObjectsList(Rect inRect, DBUnit unit, int lineNum, ref DBUnit favChange, bool onlyLabel = false)
		{
